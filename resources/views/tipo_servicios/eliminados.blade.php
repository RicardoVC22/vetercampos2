                                ...
                                <table id="example2" class="table table-bordered table-sm table-hover table-striped ">
                                    ...
                                    <tbody>
                                      @foreach ($tipo_servicios as $tipo_servicios)
                                        <tr>
                                            <td>{{$tipo_servicios->id}}</td>
                                            <td>{{$tipo_servicios->nombre}}</td>
                                            <td>{{$tipo_servicios->descripcion}}</td>
                                            <td class="text-center">
                                                <a href="#" data-href="{{url('tipo_servicio/restaurar/'.$tipo_servicios->id)}}" rel="tooltip" title="Restaurar" data-toggle="modal" data-target="#modal-confirma" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-alt-circle-up"></i></a>
                                            </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
