                                      ...
                                      @foreach ($servicios as $servicio)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" data-href="{{url('servicio/restaurar/'.$servicio->id)}}" rel="tooltip" title="Restaurar" data-toggle="modal" data-target="#modal-confirma" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-alt-circle-up"></i></a>
                                            </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
