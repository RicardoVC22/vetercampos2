...
{{-- INICIO DEL CUERPO --}}
 ...
 <div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form method="POST" enctype="multipart/form-data" action="{{asset('mascota/store')}}" autocomplete="off" class="needs-validation" novalidate>
              @method('POST')
              @csrf
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input class="form-control" id="fecha" name="fecha" type="date" pattern=".*\S+.*" placeholder="ingrese su fecha nacimiento"value="{{old('fecha')}}" required />
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" id="color" name="color" type="text" value="{{old('color')}}"placeholder="ingrese su color " pattern=".*\S+.*" autofocus required />
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" id="raza" name="raza" type="text" value="{{old('raza')}}"placeholder="ingrese su raza " pattern=".*\S+.*" autofocus required />
